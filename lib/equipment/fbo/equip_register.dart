...
class equipRegister extends StatefulWidget {
  const equipRegister({Key? key}) : super(key: key);

  @override
  State<equipRegister> createState() => _equipRegisterState();
}

class _equipRegisterState extends State<equipRegister> {
