...
class FboRegister extends StatefulWidget {
  const FboRegister({Key? key}) : super(key: key);

  @override
  State<FboRegister> createState() => _FboRegisterState();
}

class _FboRegisterState extends State<FboRegister> {
